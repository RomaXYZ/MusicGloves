...
void Timer2A_Init(void(*task)(void), uint32_t period, uint32_t priority){
  ...
  (*((volatile uint32_t *)0x40032004)) = 0x00000002;
  (*((volatile uint32_t *)0x40032028)) = period-1;
  (*((volatile uint32_t *)0x40032038)) = 0;
  (*((volatile uint32_t *)0x40032024)) = 0x00000001;
  (*((volatile uint32_t *)0x40032018)) = 0x00000001;
  (*((volatile uint32_t *)0xE000E414)) = ((*((volatile uint32_t *)0xE000E414))&0x00FFFFFF)|(priority<<29);
